...
import { hifuFaqs} from "@/lib/content/hifu"
import { businessProfile, localBusinessId, postalAddressSchema } from "@/lib/seo/business"

const pageUrl = `${businessProfile.url}/hifu-facial-craiova`

export const metadata: Metadata = {
  title: "HIFU Craiova – Lifting Facial Fără Operație | Claire Beauty Craiova",
  description:
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "HIFU Facial Craiova",
  serviceType: "HIFU Facial",
  description:
    "HIFU facial în Craiova pentru lifting fără operație, fermitate și rejuvenare.",
  url: pageUrl,
  provider: {
    "@id": localBusinessId },
  areaServed: {
