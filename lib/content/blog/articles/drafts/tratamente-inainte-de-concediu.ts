  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        ["1 săptămână înainte: Hydrablast, curățare profundă, drenaj ușor — fără iritare"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Săptămâna 6: Hydrablast cu 5–7 zile înainte de plecare; drenaj ușor opțional"],
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      type: "p",
      content: [
        "Tratamentele nu se termină la ușa salonului. În vacanță, hidratarea constantă, SPF reaplicat și evitarea excessului de alcool și sare susțin efectul drenajului și al tratamentelor faciale. Nu extrage singură comedoanele — risc de inflamație și pete post-soare. Dacă ai făcut microdermabraziune sau Hydrablast, tenul absoarbe mai bine serurile — profită de asta cu produse simple, fără parfum. La întoarcere, o ședință de drenaj sau o curățare blândă resetează pielea după zbor, clor și soare.",
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      type: "p",
      content: [
        "Concediu la mare, 10 zile, plecare peste 5 săptămâni: începe cu drenaj și anticelulitic, programează Hydrablast la 6–7 zile înainte, evită peeling chimic. City break de weekend, peste 2 săptămâni: doar Hydrablast sau curățare profesională + drenaj ușor — fără proceduri active. Nuntă sau eveniment, peste 8 săptămâni: protocol complet față + corp, cu HIFU sau microneedling la jumătatea planului și finisare cu Hydrablast în săptămâna evenimentului. Nu există plan universal — consultația personalizează calendarul.",
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      ...
      items: [
        ...
        ["Nu știi ce combini: Hydrablast, drenaj, anticelulitic, remodelare"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Recomandare tratament corect — Hydrablast, drenaj, anticelulitic sau remodelare, după calendar"],
      ],
    },
    {
      type: "callout",
  ...
  faqs: [
    {
      ...
      answer:
        "Ideal, cu 4–6 săptămâni pentru protocol corporal complet și 2–3 săptămâni pentru tratamente faciale active. Hydrablast poate fi făcut cu 3–7 zile înainte, fără downtime semnificativ.",
    },
    {
      question: "Pot face tratament facial cu o săptămână înainte de plecare?",
      answer:
        "Da, dacă alegi proceduri blânde — Hydrablast, curățare profesională, hidratare intensă. Evită peeling chimic, microneedling sau laser dacă urmează expunere la soare imediat după.",
    },
    {
