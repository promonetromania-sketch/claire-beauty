...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  blocks: [
    ...
    },
    {
      type: "ol",
      items: [
        ["6–4 săptămâni înainte: evaluare ten, eventual tratament profesional (Hydrablast, microdermabraziune)"],
    ...
    },
    {
      ...
      content: [
        "Pagina de ",
        L.tratamenteFaciale,
        " descrie opțiunile disponibile — curățare profundă, hidratare, microdermabraziune, Hydrablast — cu recomandări adaptate tipului tău de ten și calendarului estival. Evaluăm, tratăm și îți explicăm ce merită acasă vs ce necesită mâini profesioniste.",
      ],
    },
    {
      type: "callout",
  ...
  faqs: [
    ...
    {
      question: "Hydrablast este potrivit pre-vară?",
      answer:
