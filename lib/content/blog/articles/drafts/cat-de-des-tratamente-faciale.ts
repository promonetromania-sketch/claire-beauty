...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  excerpt:
    "Hydrablast lunar sau la trei luni? microneedling de două ori pe an sau la șase săptămâni? Frecvența tratamentelor faciale depinde de procedură, tip de ten și obiectiv — nu de o regulă universală.",
  metaDescription:
    "Cât de des poți face tratamente faciale: frecvențe pe proceduri (Hydrablast, microdermabraziune, HIFU) și obiective. Ghid Claire Beauty Craiova.",
  keywords: [
  ...
  blocks: [
    ...
    },
    {
      type: "p",
      content: [
        "Două variabile decid intervalul: intensitatea tratamentului și obiectivul tău. Tratamentele blânde de curățare și hidratare — precum Hydrablast — pot fi făcute frecvent, chiar lunar. Tratamentele care stimulează repararea profundă — microneedling, microneedling, peelinguri chimice — necesită pauze de 4–6 săptămâni între ședințe, timp în care pielea se reface. Tratamentele de lifting cu energie — HIFU — se fac de 1–2 ori pe an. Consultația inițială și ",
    ...
    {
      type: "h2",
      text: "microneedling: pauze obligatorii",
    },
    {
      type: "p",
      content: [
        ...
        " include oprirea retinoizilor cu câteva zile înainte — esențial pentru microneedling.",
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      type: "p",
      content: [
        "Distincția crucială: protocol activ (rezolvă o problemă — pete, cicatrici, ten tern cronic) vs întreținere (menține rezultatele). Un protocol activ de microneedling sau microdermabraziune durează 2–4 luni, cu frecvență ridicată. Apoi treci la întreținere — Hydrablast lunar, microdermabraziune ocazională, HIFU anual. Mulți clienți fac greșeala să oprească complet după protocol — rezultatele se estompează în 3–6 luni fără menținere.",
      ],
    },
    {
      type: "h3",
    ...
    },
    {
      type: "ol",
      items: [
        ["Ianuarie–martie: protocol microneedling (4 ședințe, la 4 săptămâni)"],
        ["Aprilie–septembrie: Hydrablast la 4–6 săptămâni"],
        ["Octombrie: microdermabraziune (reset post-vară)"],
        ["Noiembrie: HIFU (dacă e indicat)"],
        ["Decembrie: Hydrablast pre-sărbători"],
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      type: "p",
      content: [
        "Dacă ești într-un protocol activ și intervalul depășește 6 săptămâni între ședințe de microneedling sau microdermabraziune, progresul se pierde parțial — colagenul stimulat se reabsoarbe, celulele noi nu se acumulează. Pentru Hydrablast, prea rar înseamnă tenul revine la starea inițială — pori înfundati, opacitate. Regula: respectă intervalul recomandat de specialist, nu amâna ședințele fără motiv.",
      ],
    },
    {
      type: "h2",
    ...
    },
    {
      type: "p",
      content: [
        "Tenul tânăr (20–30 ani) reface rapid — poate tolera intervale mai scurte între tratamente blânde, dar tot nu abuzează de active. Tenul matur (40+) reface mai lent — pauze mai lungi după microneedling sau microdermabraziune, uneori 5–6 săptămâni. Tenul sensibil: Hydrablast preferat, microdermabraziune la intensitate redusă, doar după test de toleranță. Tenul gras: curățare mai frecventă, dar fără a strip-ui bariera. Nu copia frecvența unei prietene — pielea ta are ritmul ei.",
      ],
    },
    {
      type: "h3",
    ...
    },
    {
      type: "ul",
      items: [
        ["Hydrablast: 4–6 săptămâni (întreținere); 3–4 săptămâni (ten gras activ)"],
        ["Microdermabraziune: 4–6 săptămâni (întreținere); 2–3 săptămâni (protocol activ)"],
        ["microneedling: 4–6 săptămâni (protocol); 3–6 luni (întreținere post-protocol)"],
    ...
    },
    {
      type: "p",
      content: [
        "Mulți clienți alternează proceduri — Hydrablast între ședințele de microneedling, microdermabraziune după un protocol de vară. Regula de bază: o procedură activă principală, restul complementar, cu pauze clare. Exemplu: microneedling la 4 săptămâni ca tratament principal; Hydrablast la 2 săptămâni după fiecare microneedling pentru curățare și hidratare, când pielea s-a refăcut. Nu suprapune microdermabraziune și microneedling în aceeași săptămână — ambele sunt active. Specialistul la ",
        L.contact,
    ...
    },
    {
      type: "p",
      content: [
        "Andreea, 27 de ani, ten gras cu pori dilatați pe nas și obrajii cu textură aspră. Obiectiv: ten curat, fără inflamații, machiaj care rezistă toată ziua. Nu vrea protocol agresiv — preferă regularitate. Plan propus: luna 1–2 — Hydrablast la 3 săptămâni (curățare profundă, fără downtime); luna 3 — evaluare: dacă porii rămân vizibili, se introduce microdermabraziune ușoară la 4 săptămâni distanță; luna 4–6 — alternanță Hydrablast / microdermabraziune, cu BHA acasă de 2 ori pe săptămână și SPF zilnic. Fără microneedling în prima fază — tenul gras activ beneficiază mai întâi de curățare stabilă. Andreea notează în telefon data fiecărei ședințe — respectarea intervalului previne suprasolicitarea. După 5 luni, porii par mai puțin înfundati, tenul mai mat natural, nu doar « degresat ». Scenariul diferă de protocoalele corporale: fața tolerează curățări mai dese, dar nu combină active intense în aceeași săptămână.",
      ],
    },
    {
      type: "h2",
  ...
  faqs: [
    {
      question: "Pot face Hydrablast o dată pe lună?",
      answer:
        "Da, lunar este frecvența standard de întreținere pentru Hydrablast. Tenul gras sau cu pori vizibili poate beneficia de ședințe la 3–4 săptămâni în primele luni.",
    },
    {
      question: "Cât timp trebuie să aștept între ședințe de microneedling?",
      answer:
    ...
    {
      question: "Pot combina Hydrablast cu microdermabraziune în aceeași lună?",
      answer:
        "Da, dar nu în aceeași zi sau săptămână. Hydrablast poate fi făcut la 2–3 săptămâni după microdermabraziune, când pielea s-a refăcut. Specialistul stabilește ordinea.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Depinde de obiective. Pentru întreținere: 6–10 ședințe Hydrablast. Pentru protocol activ (microneedling, pete): 4–6 ședințe concentrate plus întreținere.",
    },
    {
