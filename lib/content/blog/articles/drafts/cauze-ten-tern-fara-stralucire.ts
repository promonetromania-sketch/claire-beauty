...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  blocks: [
    ...
    },
    {
      type: "p",
      content: [
        "Pentru menținerea luminozității: Hydrablast la 4–6 săptămâni, microdermabraziune la 4–8 săptămâni. Pentru ten foarte tern: protocol inițial de 3 ședințe la 2–3 săptămâni distanță, apoi întreținere. Rezultatul se cumulează — nu aștepta miracol după o singură vizită dacă problema e cronică.",
      ],
    },
    {
      type: "h3",
  ...
  faqs: [
    ...
    {
      question: "Cât de repede văd diferență după Hydrablast?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Depinde de gradul de sensibilitate. Microdermabraziunea clasică poate fi prea intensă; Hydrablast sau variante blânde pot fi alternative. Consultația evaluează toleranța.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Hydrablast: la 4–6 săptămâni. Microdermabraziune: la 4–8 săptămâni. După un protocol inițial, întreținerea se adaptează sezonului și stilului tău de viață.",
    },
  ],
}
