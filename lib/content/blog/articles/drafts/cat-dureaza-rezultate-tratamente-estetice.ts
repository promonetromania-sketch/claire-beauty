...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  excerpt:
    "Hydrablast, HIFU, sau remodelare corporală — fiecare tratament are propriul calendar de rezultate. Află ce poți aștepta realist, ședință cu ședință, la Claire Beauty Craiova.",
  metaDescription:
  ...
  blocks: [
    ...
    },
    {
      ...
      content: [
        ...
        { text: "Hydrablast pentru începători", href: "/blog/ce-este-hydrablast-beneficii-craiova" },
        " detaliază ce simți după prima vizită.",
      ],
    },
    {
      type: "h3",
      text: "Timeline Hydrablast și faciale similare",
    },
    {
      type: "ul",
      items: [
    ...
    },
    {
      type: "ul",
      items: [
        ["Hydrablast / curățare profundă: imediat – 24 h; menținere 2–4 săptămâni"],
    ...
    },
    {
      ...
      items: [
        ...
        ["Compari tratamente diferite (HIFU vs Hydrablast) — ai nevoie de ghid"],
  ...
  faqs: [
    {
      ...
      answer:
        "Tratamentele profunde (HIFU, microneedling, radiofrecvență) stimulează regenerarea — procesul durează săptămâni. Doar procedurile superficiale (Hydrablast, curățare) oferă efect vizibil în aceeași zi.",
    },
    {
      question: "Cât durează efectul unui Hydrablast?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Depinde de tratament și stil de viață. HIFU și microneedling oferă efecte de lungă durată (luni–ani), dar aging-ul continuă. Hydrablast și curățarea necesită întreținere regulată. Niciun tratament estetic nu oprește timpul.",
    },
  ],
}
