...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: [
        ...
        L.microneedling,
        " — colagen pentru piele din jurul porilor, cicatrici post-acnee. Frecvența: Hydrablast la 3–4 săptămâni pe ten gras; microdermabraziune la 4–6 săptămâni; microneedling la 4–6 săptămâni în protocol. Detalii despre fiecare procedură pe pagina de ",
        L.tratamenteFaciale,
        ".",
      ],
    },
    ...
    },
    {
      ...
      content: [
        ...
        " — Hydrablast sau microdermabraziune, după evaluare.",
      ],
    },
    {
      type: "ul",
    ...
    {
      type: "h2",
      text: "Soluții posibile — Hydrablast, microdermabraziune, microneedling",
    },
    {
      type: "p",
      content: [
        "Hydrablast curăță profund; microdermabraziune refinează textura; microneedling stimulează colagenul din jurul porilor. Detalii pe ",
        L.tratamenteFaciale,
    ...
    },
    {
      ...
      items: [
        ...
        ["Recomandare tratament corect — Hydrablast, microdermabraziune sau microneedling, după caz"],
      ],
    },
    {
      type: "callout",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Zona T are cele mai multe glande sebacee. Nasul produce mai mult sebum, iar foliculii sunt natural mai dilatați. Curățare regulată și BHA ajută; Hydrablast curăță profund zona.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Hydrablast: la 3–4 săptămâni pe ten gras. Microdermabraziune: la 4–6 săptămâni. Microneedling: la 4–6 săptămâni în protocol activ. Respectă intervalele — pielea trebuie să se refacă.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Da. Presiunea traumatizează foliculul, poate cauza inflamație, cicatrici și dilatare permanentă. Extragerea profesională în cadrul Hydrablast sau curățării estetice este sigură.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Depinde de cauză: sebum și înfundare — Hydrablast; textură aspră — microdermabraziune; laxitate și cicatrici — microneedling. Consultația stabilește combinația potrivită.",
    },
  ],
}
