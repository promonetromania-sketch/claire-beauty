...
const post: Omit<BlogPost, "readTimeMinutes"> = {
  ...
  blocks: [
    ...
    },
    {
      type: "p",
      content: [
        "Dacă ai ten sensibil, cuperoză sau rosacee, recuperarea post-soare cere și mai multă prudență. Soarele poate declanșa pusee de roșeață care persistă săptămâni după vacanță. Evită apă foarte fierbinte la spălare, produse cu alcool sau mentol, scrub-uri și tratamente termice acasă. Ingredientele calmante — azelaic acid în concentrație mică, centella, niacinamidă blândă — pot ajuta, dar introducerea e treptată. La salon, protocoalele agresive sunt contraindicate până la stabilizare; Hydrablast blând sau hidratare profesională sunt adesea singurele opțiuni sigure în primele săptămâni. Comunică diagnosticul sau sensibilitatea înainte de programare — adaptarea protocolului previne regresul, nu doar disconfortul temporar.",
      ],
    },
    {
      type: "h2",
  ...
  faqs: [
    ...
    {
      question: "Hydrablast e sigur după expunere la soare?",
      answer:
        "Da, dacă nu ai arsură activă sau piele foarte inflamată. Hydrablast e blând, hidratant — adesea ideal 2–4 săptămâni post-vacanță. Consultația confirmă dacă e momentul potrivit.",
    },
    {
