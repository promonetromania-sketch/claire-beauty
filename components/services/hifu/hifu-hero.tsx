...
export function HifuHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/treatment-facial.jpg"
          alt="HIFU Craiova la Claire Beauty"
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.22em] text-[#D4AF37]">
            Tratament premium anti-aging
          </p>
          <h1 className="mb-6 font-serif text-4xl font-semibold leading-tight text-[#FFF9F2] sm:text-5xl lg:text-6xl">
            HIFU Craiova – Lifting Facial Fără Operație, Rejuvenare Profundă și
            Efect Vizibil de Întinerire
          </h1>
          <p className="mb-4 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            Dacă începi să observi că pielea își pierde fermitatea, conturul
            feței nu mai este la fel de definit sau ridurile devin mai vizibile,
            există o soluție eficientă — fără operație. HIFU este unul dintre
            cele mai avansate tratamente de lifting facial, care acționează în
            profunzime și oferă rezultate naturale, progresive.
          </p>
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            ...
            este una dintre cele mai eficiente metode de lifting facial fără
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              <a href="tel:+40757851882" className="flex items-center gap-2">
                ...
                <span>Începe rejuvenarea pielii</span>
              </a>
            </Button>
            <Button
              asChild
            ...
            >
              <Link href="/contact" className="flex items-center gap-2">
                ...
                <span>Consultație pentru lifting facial</span>
              </Link>
            </Button>
          </div>
        </div>
