...
export function TratamenteCorporaleHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <ClaireImage
          {...claireImages.tratamenteCorporaleHero}
          fill
          priority
          sizes="100vw"
        />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.22em] text-[#D4AF37]">
            Hub tratamente corporale · Claire Beauty Craiova
          </p>
          ...
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            Descoperă tratamente corporale profesionale în Craiova, dedicate
            remodelării, relaxării și îngrijirii corpului, într-un spațiu elegant
            și primitor la{" "}
            <Link
              href="/"
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap">
            ...
            >
              <Link href="#tratamente-disponibile" className="flex items-center gap-2">
                Vezi tratamentele
              </Link>
            </Button>
            <Button
