...
const whatsappMessage =
  "Bună ziua! Aș dori să programez o ședință de electrostimulare la Claire Beauty Craiova."

export function ElectrostimulareHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/treatment-body.jpg"
          alt="Electrostimulare Craiova la Claire Beauty"
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          ...
          <h1 className="mb-6 font-serif text-4xl font-semibold leading-tight text-[#FFF9F2] sm:text-5xl lg:text-6xl">
            Electrostimulare Craiova – Tonifiere Rapidă, Ardere Calorică și
            Remodelare Corporală Fără Efort Intens
          </h1>
          <p className="mb-4 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            Dacă vrei un corp mai tonifiat, dar nu ai timp pentru sală sau nu
            vezi rezultate în zonele problematice, electrostimularea poate fi
            exact soluția potrivită pentru tine. În Craiova, electrostimularea
            este unul dintre cele mai eficiente tratamente pentru tonifiere fără
            efort.
          </p>
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            ...
            >
              Procedura de electrostimulare
            </Link>{" "}
            în Craiova este integrată într-un protocol complet de remodelare
            corporală, pentru rezultate reale: tonifiere, definire și susținerea
            slăbirii. Practic, corpul tău lucrează chiar dacă tu stai relaxat.
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              <a href="tel:+40757851882" className="flex items-center gap-2">
                ...
                <span>Începe tonifierea corpului</span>
              </a>
            </Button>
            <Button
              asChild
