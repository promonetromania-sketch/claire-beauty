...
const whatsappMessage =
  "Bună ziua! Aș dori să programez o ședință de masaj terapeutic la Claire Beauty Craiova."

export function MasajTerapeuticHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/treatment-reflexology.jpg"
          alt="Masaj terapeutic Craiova la Claire Beauty"
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          ...
          <h1 className="mb-6 font-serif text-4xl font-semibold leading-tight text-[#FFF9F2] sm:text-5xl lg:text-6xl">
            Masaj Terapeutic Craiova – Recuperare, Relaxare și Eliminarea
            Durerilor Musculare
          </h1>
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            Durerile de spate, tensiunea musculară și oboseala acumulată sunt
            probleme din ce în ce mai frecvente, mai ales în contextul unui
            stil de viață sedentar sau stresant. Fie că lucrezi la birou sau ai
            o activitate fizică intensă, aceste probleme nu dispar de la sine și
            necesită intervenție directă asupra musculaturii. Procedura de{" "}
            <Link
              href="/"
            ...
            acționează asupra musculaturii și ajută la reducerea durerilor și
            tensiunii.
          </p>
