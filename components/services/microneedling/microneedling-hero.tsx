...
export function MicroneedlingHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/treatment-facial.jpg"
          alt="Microneedling Craiova la Claire Beauty"
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          ...
          <h1 className="mb-6 font-serif text-4xl font-semibold leading-tight text-[#FFF9F2] sm:text-5xl lg:text-6xl">
            Microneedling Craiova – Tratament Eficient pentru Cicatrici, Acnee
            și Rejuvenare a Tenului
          </h1>
          <p className="mb-4 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            Dacă te confrunți cu cicatrici post-acnee, pori dilatați sau un ten
            neuniform care nu răspunde la produse cosmetice, trebuie să știi un
            lucru: aceste probleme nu se rezolvă la suprafață. Microneedling
            este unul dintre cele mai eficiente tratamente care acționează în
            profunzime, ajutând pielea să se regenereze natural.
          </p>
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            ...
            stimulează regenerarea pielii și îmbunătățește textura acesteia în
            mod natural.
          </p>
