...
const whatsappMessage =
  "Bună ziua! Aș dori să programez o ședință de masaj anticelulitic la Claire Beauty Craiova."

export function MasajAnticeluliticHero() {
  return (
    <section className="relative flex min-h-[78vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/treatment-body.jpg"
          alt="Masaj anticelulitic Craiova la Claire Beauty"
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-36 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in-up rounded-[2rem] border border-white/15 bg-white/10 p-6 shadow-premium-lg backdrop-blur-md sm:p-8">
          ...
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-[#FFF9F2]/90">
            ...
            sport fără rezultate vizibile, nu ești singura. Celulita este una
            dintre cele mai persistente probleme estetice și necesită o abordare
            corectă și constantă. Procedura de{" "}
            <Link
              href="/"
            ...
            acționează direct asupra țesutului adipos și ajută la îmbunătățirea
            aspectului pielii. Rezultatul? Piele mai fermă, aspect vizibil
            îmbunătățit și o siluetă mai armonioasă.
          </p>
